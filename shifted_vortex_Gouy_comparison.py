...
Generate shifted vortex beam as combination of fundamental Gaussian and a Laguerre-Gauss beam. 
Use the paraxial propagation formulas (implemented in custom module optics_library.sources) 
to generate an animation of the shifted vortex with and without the Gouy phase term. 
This demonstrates that the rotation of the shifted vortex is caused **directly** by the Gouy phase. 
@author: Olga Baladron-Zorita
"""
